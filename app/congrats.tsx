...
const Congrats = () => {
  ...
  return (
    <View className='flex-row h-full w-full justify-center items-center bg-white'>
        ...
        <View className='py-10 items-center'>
            ...
            <CustomButton text='Great!' className={'rounded-full w-40'} textClassName='text-xl' onPress={goHome} />
        </View>
        </View>
    </View>
  )
