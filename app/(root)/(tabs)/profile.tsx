      ...
      {userData ? (
        <>
          ...
          <View className="bg-white bor p-4 shadow-slate-300 mb-4">
            ...
            <View className="flex-row justify-between border-b-[1px] py-3 border-[#BEBEBEBE]"><Text className="text-gray-600">Pending Investment:</Text><Text>EG 0.00</Text></View>
            <View className="flex-row justify-between border-b-[1px] py-3 border-[#BEBEBEBE]"><Text className="text-gray-600">EG Balance:</Text><Text>EG 0.00</Text></View>
