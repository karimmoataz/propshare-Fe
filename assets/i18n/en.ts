export default {
    ...
    forgotPassword: {
        ...
        subtitle: "Enter your email and follow the instructions to reset your password",
        email_placeholder: "Enter Your Email address",
        code_placeholder: "Enter Reset Code",
        ...
        errors: {
            ...
            send_code_error: "Failed to send reset code. Please try again.",
    ...
    eWallet: "E-Wallet",
    instaPay: "InstaPay",
    usuallyUpTo1WorkingDayToWithdraw: "Usually up to 1 working day to withdraw",
    coupleOfHoursToTransfer: "Couple of hours to transfer",
    missingInformation: "Missing Information",
    pleaseSelectYourBank: "Please select your bank",
    pleaseEnterReceiverName: "Please enter receiver name",
    pleaseRnterYourIBAN: "Please enter your IBAN",
    pleaseRnterYourEwalletProvider: "Please enter your e-wallet provider",
    pleaseRnterYourAccountNumber: "Please enter your account number",
    pleaseRnterYourInstaPayID: "Please enter your InstaPay ID",
    pleaseRnterYourRegisteredMobileNumber: "Please enter your registered mobile number",
    availableBalance: "Available Balance",
    amountYouWantToWithdraw: "Amount you want to withdraw",
    pleaseSelectAWithdrawalMethod: "Please select a withdrawal method",
    feesApply: "Fees apply",
    enterAmount: "Enter amount",
    inCaseYouForgotAnyRequiredDetailsContactYourBankForAssistance: "In case you forgot any required details, contact your bank for assistance.",
    bankName: "Bank Name",
    cancel: "Cancel",
    receiverName: "Receiver Name",
    back: "Back",
    submit: "Submit",
    pleaseProvideYourEWalletInformationForWithdrawal: "Please provide your e-wallet information for withdrawal",
    eWalletProvider: "E-Wallet Provider",
    accountNumber: "Account Number",
    searchBanks: "Search banks...",
    enterNameOfBankAccountHolder: "Enter name of bank account holder",
    exampleEG210900020202kddosjf: "Example: EG210900020202kddosjf",
    enterYourEWalletProvider: "Enter your e-wallet provider",
    enterYourEWalletAccountNumber: "Enter your e-wallet account number",
    pleaseProvideYourInstaPayInformationForWithdrawal: "Please provide your InstaPay information for withdrawal",
    instaPayID: "InstaPay ID",
    enterYourInstaPayID: "Enter your InstaPay ID",
    registeredMobileNumber: "Registered Mobile Number",
    enterYourRegisteredMobileNumber: "Enter your registered mobile number",
    withdrawalRequestSubmitted: "Withdrawal request submitted",
    yourWithdrawalRequestHasBeenSubmittedSuccessfullyYouCanTrackTheStatusInYourWithdrawalHistory: "Your withdrawal request has been submitted successfully. You can track the status in your withdrawal history.",
    amount: "Amount",
    method: "Method",
    status: "Status",
    pending: "Pending",
    ...
    youDontHaveEnoughBalanceForThisWithdrawal: "You don't have enough balance for this withdrawal",
    invalidAmount: "Invalid Amount",
    pleaseEnterAValidAmount: "Please enter a valid amount",
    bankInformation: "Bank Information",
    eWalletInformation: "E-Wallet Information",
    instaPayInformation: "InstaPay Information",
    chooseWithdrawalMethod: "Choose Withdrawal Method",
